...
public class JobService {
    ...
    public String enqueue(String goal, String planId, String workspace) throws Exception {
    ...
    private void workerLoop() {
        while (true) {
            try {
                ...
                JsonNode res = engine.run(goal, planId, workspace);
