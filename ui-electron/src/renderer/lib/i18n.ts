...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    messages: {
      ...
      confirmCancel: "Are you sure you want to cancel? This will terminate the running task.",
      ...
      workspaceIntro: "Navigation is based on this workspace path:",
